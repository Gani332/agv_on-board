...
- `scripts/logging/validate_ros2_bag.py` for ROS 2 bag directories and `.db3`
...
- `scripts/logging/validate_ros2_bag.py` for ROS 2 `.db3` / rosbag2 folders
...
| `3.3 clock_sync` | Multi-robot timestamps are not trustworthy | Repair chrony/NTP before publishable collection |

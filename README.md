...
RGB-D profile:                  raw color + raw depth, 640x480 at 15 Hz
Depth topic:                    /camera/depth/image_rect_raw
D455 IMU rate:                  raw gyro about 200 Hz, raw accel about 100 Hz
...
Non-moving gate check before a lab run:
...
MOCAP_TOPIC=/optitrack/rigid_bodies/orkar_agv102 \
CMD_TOPIC=/agv102/cmd_vel \
bash scripts/scenarios/run_s1_mocap_pilot_robot.sh agv102 s1_dry_gate
```
